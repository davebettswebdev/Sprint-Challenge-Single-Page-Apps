...
- [X]  Explain benefit(s) using `client-side routing`?
    ...
    Client-side routing allows us to manage the client with no need to re-load the webpage. Data is loaded and re-renderd quickly and efficently using routers. Only the part of the page that changes has to be re-loaded. 
